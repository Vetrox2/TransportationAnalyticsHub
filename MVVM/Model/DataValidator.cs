...
namespace TransportationAnalyticsHub.MVVM.Model
{
    public static class DataValidator
    {
        ...
        private const string DoubleValidation = @"^[0-9]+([,.][0-9]{0,})?$";
        ...
        public static bool ValidateDouble(string text) => Regex.Match(text, DoubleValidation).Success;
        ...
        public static bool ValidateNotFutureDateTime(DateTime date) => date <= DateTime.Now;
